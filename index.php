...
$query = "select izin.*, guru.nama as nama_guru, bk.nama as nama_bk from izin inner join guru on guru.id =
 izin.guru_id inner join bk on bk.id = izin.bk_id where siswa_id = 2;";
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.php" class="text-nowrap logo-img">
            <img src="assets/images/logos/Logonew.png" width="130" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="ui-buat-izin.php" aria-expanded="false">
                <span>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="assets/images/profile/rr.jpg" alt="" width="35" height="35" class="rounded-circle">
                </a>
